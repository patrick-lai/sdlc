...
- Never merge. Automatic PR comments and Slack notifications are outside scheduled review. An additional explicit request to publish blocker comments permits only the verified inline blocker comments described in [`references/blocking-pr-comment.md`](blocking-pr-comment.md).
