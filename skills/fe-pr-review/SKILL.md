---
name: fe-pr-review
description: Review frontend changes with focused parallel specialists, complete risk coverage and concrete defect evidence. Use for frontend pull requests or local diffs.
---

# Frontend review

Use [the focused workflow](references/workflow.md) and the frontend section of [review lenses](references/lenses.md). If `review` or the host already supplied a snapshot, requirements or focus, reuse them. If coordinating, partition the relevant risks and launch independent specialists concurrently. If already a specialist, finish the assigned scope without starting another panel. Return findings and remaining gaps in the requested format.
